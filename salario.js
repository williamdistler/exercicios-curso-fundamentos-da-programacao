 ...
 * O retorno da função deve ser a string "Salário igual a R$X", em que X é o quanto
 * o funcionário ganhou no mês.
 * Exemplos:
 * calcularSalario(150, 40.5) // retornará "Salário igual a R$6075"
 */

const calcularSalario = (horasTrabalhadas, horaSalario) => {
  return `Salário igual a R$ ${horasTrabalhadas * horaSalario}`
}
